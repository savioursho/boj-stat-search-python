...
def test_get_data_layer_raw_accepts_frequency_enum():
    db = "MD10"
    layer = "*"
...
def test_get_data_layer_raw_normalizes_lowercase_frequency():
    db = "MD10"
    layer = "*"
    expected_url = build_data_layer_api_url(
        db=db,
...
def test_get_data_layer_raw_accepts_layer_class():
    db = "BP01"
    frequency = "M"
    layer = Layer(1, 1, 1)
    expected_url = build_data_layer_api_url(
...
def test_get_data_layer_raw_with_optional_params_uses_client_and_returns_json():
    db = "BP01"
    frequency = "M"
    layer = "1,1,1"
    start_date = "202504"
...
def test_get_data_layer_with_optional_params_uses_client_and_returns_parsed_response():
    db = "BP01"
    frequency = "M"
    layer = "1,1,1"
    start_date = "202504"
    ...
    raw_payload = {
        ...
        "RESULTSET": [
            {
                "SERIES_CODE": "",
                "NAME_OF_TIME_SERIES_J": "some layer",
                "UNIT_J": "",
                "FREQUENCY": "",
                "CATEGORY_J": "",
                "LAST_UPDATE": "",
